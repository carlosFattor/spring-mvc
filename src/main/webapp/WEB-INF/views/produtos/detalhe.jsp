  ...
  <header id="layout-header">
	...
	<article id="livro-css-eficiente">
	  ...
	  <form:form servletRelativeAction="/carrinho/add" method="post" cssClass="container">
	    ...
	    <button type="submit" class="submit-image icon-basket-alt" title="Compre Agora">Compre Agora</button>
	...
	<div class="container">
	  ...
	  <section class="data product-detail">
	    ...
	    <p>Número de páginas: <span>${produto.nPaginas }</span></p>
	    <p></p>
	    <p>Data de publicação: <fmt:formatDate pattern="dd/MM/yyyy" value="${produto.lancamento.time }" /> </p>
